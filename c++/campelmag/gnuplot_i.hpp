...
class Gnuplot
{
    ...
    Gnuplot& savetops(const std::string &filename = "gnuplot_output");
		Gnuplot& savetosvg(const std::string &filename = "gnuplot_output");
		Gnuplot& savetojpg(const std::string &filename = "gnuplot_output");
		Gnuplot& savetopng(const std::string &filename = "gnuplot_output");
		Gnuplot& savetopdf(const std::string &filename = "gnuplot_output");
		Gnuplot& savetoepslatex(const std::string &filename = "gnuplot_output");
...
Gnuplot& Gnuplot::savetosvg(const std::string &filename)
{
    cmd("set terminal svg fname 'Verdana' fsize 10");
...
Gnuplot& Gnuplot::savetojpg(const std::string &filename)
{
    cmd("set terminal jpg color enhanced font 'Verdana,10'");
...
{
    cmd("set terminal pngcairo enhanced font 'Verdana,10'");
...
Gnuplot& Gnuplot::savetoepslatex(const std::string &filename)
{
    cmd("set terminal epslatex color colortext");

    std::ostringstream cmdstr;
    cmdstr << "set output \"" << filename << ".tex\"";
    cmd(cmdstr.str());
